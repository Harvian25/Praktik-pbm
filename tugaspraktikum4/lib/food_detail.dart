          ...
          child: Column(
            children: [
              Container(
                ...
                color: Color.fromARGB(255, 197, 190, 96),
                child: Column(
                  children: [
                    Row(
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Container(
                            decoration: BoxDecoration(
                              color: Color.fromARGB(255, 208, 202, 91),
      ...
      bottomNavigationBar: Container(
        ...
        child: ElevatedButton(
          ...
          style: ElevatedButton.styleFrom(
            primary: Color.fromARGB(255, 220, 202, 85),
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        Text(
          "$buyFood",
          style: TextStyle(color: Color.fromARGB(255, 255, 252, 247)),
        ),
        IconButton(
          onPressed: _incFood,
          icon: Icon(
