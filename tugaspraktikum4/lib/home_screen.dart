                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                          color: Color.fromARGB(255, 255, 255, 95),
                    ...
                    return GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Card(
                          ...
                          color: Color.fromARGB(255, 114, 128, 71),
                          child: Padding(
                  ...
                  children: [
                    ...
                    TextButton(
                      ...
                      child: Text(
                        "See all",
                        style: TextStyle(
                          color: Color.fromARGB(255, 133, 146, 62),
                        ),
                      ),
                    )
                  ],
                        ...
                        Row(
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: Color.fromARGB(255, 101, 105, 50),
  ...
  Widget build(BuildContext context) {
    return IconButton(
      ...
      icon: Icon(
        ...
        color: Color.fromARGB(255, 231, 255, 95),
        size: 24.0,
      ),
    );
  }
